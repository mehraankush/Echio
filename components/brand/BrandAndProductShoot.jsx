		...
		<SmoothScroll>
			...
			>
				...
				<div className=" text-black  bg-white">
					<div className="pt-5 bg-black " ref={container}>
						<Parallax>

						<div className="lg:flex justify-center items-center gap-10 lg:py-5 lg:ml-20 lg:mr-[6.5rem] ">
							<div
						...
						<div className="lg:flex flex-row-reverse justify-center items-center gap-10 py-20 lg:py-28 lg:ml-10 lg:mr-[6.5rem] bg-white ">
							<div
