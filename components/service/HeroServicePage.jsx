	...
	return (
		...
		>
			...
			<div className="p-4 pt-0 lg:flex flex-col justify-center items-center">
				...
				<div className="h-[800px] mt-[2rem] px-8">
			...
			<div className="flex md:hidden mt-[-7rem] flex-col justify-center items-center lg:mx-[5rem] lg:mt-[9.75rem] ">
				<div className="m-8 lg:m-0 lg:flex flex-row-reverse justify-center items-center gap-20">
					<div className="lg:flex flex-col">
						...
						<p className="text-xl font-syne mb-10 text-white">
