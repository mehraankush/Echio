									...
									<CarouselItem key={index} className="w-full">
										...
										<div className="flex justify-center items-center gap-8">
											...
											<div className="inline-block text-center">
												<h1 className="font-inter font-bold text-2xl text-black">{item.name}</h1>
												<p className="font-inter text-lg text-black">{item.position}</p>
											</div>
										</div>
									</CarouselItem>
								))}
...
export default WhiteTestmonilas